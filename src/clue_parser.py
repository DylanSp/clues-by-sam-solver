...
from z3 import And, Not, Or, Solver

from models import Column, Direction, Parity, Verdict
from puzzle_suspect import PuzzleSuspect, count_suspects_with_verdict
...
class PuzzleProtocol(Protocol):
    ...
    def _only_one_of_set_matches_criteria(
        self, suspects: set[PuzzleSuspect], criteria: Callable[[PuzzleSuspect], Any]
    ): ...


class ClueParserMixin:
    def add_constraints_from_clue(self: PuzzleProtocol, clue: str, suspect_with_clue: str = ""):
        match clue.split():
            case [
                "Exactly",
                num_suspects,

...
def all_suspects_with_verdict_are_connected(suspects: list[Verdict], verdict: Verdict) -> bool:
    ...
    suspect1_check = suspect_matches_verdict or not (verdict_exists_to_left and verdict_exists_to_right)
    ...
    suspect2_check = suspect_matches_verdict or not (verdict_exists_to_left and verdict_exists_to_right)
...
class TestConnectedDetectionLogic(unittest.TestCase):
    def test_connected_detection(self):
        for test_case in test_cases:
            innocents_are_connected = all_suspects_with_verdict_are_connected(test_case.verdicts, Verdict.INNOCENT)
            self.assertEqual(
                innocents_are_connected,
            ...
            criminals_are_connected = all_suspects_with_verdict_are_connected(test_case.verdicts, Verdict.CRIMINAL)
            self.assertEqual(
                criminals_are_connected,
